      ...
      return WrappedComponent => {
        ...
        const connector = connect(
          ...
          (dispatch, initialProps) => {
            const bindForm = actionCreator => isFunction(actionCreator) && actionCreator.bind(null, initialProps.form)
        ...
        return class ReduxForm extends Component {
          constructor(props, context) {
            super(props, context)
            this.valid = this.refs.wrapped && this.refs.wrapped.getWrappedInstance().isValid()
            this.invalid = !this.valid
            this.pristine = this.refs.wrapped && this.refs.wrapped.getWrappedInstance().isPristine()
            this.dirty = !this.pristine
            this.values = this.refs.wrapped && this.refs.wrapped.getWrappedInstance().getValues()
            this.fieldList = this.refs.wrapped && this.refs.wrapped.getWrappedInstance().getFieldList()
            this.wrappedInstance = this.refs.wrapped && this.refs.wrapped.getWrappedInstance().refs.wrapped
          }
