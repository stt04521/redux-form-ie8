...
const createField = ({ deepEqual, getIn, setIn }) => {
  ...
  class Field extends Component {
    constructor(props, context) {
      ...
      this.pristine = this.refs.connected && this.refs.connected.getWrappedInstance().isPristine()
      this.value = this.refs.connected && this.refs.connected.getWrappedInstance().getValue()
