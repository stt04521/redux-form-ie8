...
const createFields = ({ deepEqual, getIn }) => {
  ...
  class Fields extends Component {
    constructor(props, context) {
      ...
      this.dirty = this.refs.connected && this.refs.connected.getWrappedInstance().isDirty()
      this.pristine = !this.dirty
      this.values = this.refs.connected && this.refs.connected.getWrappedInstance().getValues()
